...
| **Docker** ![Docker](poc/icons/docker.png) | **CoreDNS** ![CoreDNS](poc/icons/coredns.png) | **Redis** ![Redis](poc/icons/redis.png) | **Flask** ![Flask](poc/icons/flask.png)   | **NGINX** ![NGINX](poc/icons/nginx.png)   |
---
## Table of Contents
